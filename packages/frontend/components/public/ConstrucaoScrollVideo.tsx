      ...
      <div className="sticky top-0 h-screen w-full flex items-center">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-2 md:gap-8 pt-8 md:pt-12">
          ...
          >
            ...
            <h2
              className="font-serif font-bold text-slate-900 leading-[1.1] md:leading-[1.05] tracking-tight mb-2"
            ...
            <p className="font-sans text-xs md:text-sm text-slate-600 leading-relaxed mb-3 md:mb-4 max-w-md">
              ...
              {etapas.map(({ icon: Icon, label, sub }, i) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-0.5">
                    <span className="font-sans text-[10px] md:text-[11px] font-black uppercase tracking-[0.2em] text-slate-900 leading-tight">
                      {label}
                    </span>
                    <span className="font-sans text-[8px] md:text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                      {sub}
                    </span>
                  </div>
                </motion.div>
            ...
            <div className="w-full mb-3 md:mb-4">
              <div className="flex justify-between mb-1">
                <span className="font-sans text-[7px] md:text-[8px] font-black uppercase tracking-widest text-slate-500">
                  Progresso da Obra
                </span>
              ...
              <div className="h-px w-full bg-slate-200 relative overflow-hidden rounded-full">
                <motion.div
            ...
            <Link
              ...
              className="group flex items-center gap-3 font-sans text-[10px] md:text-xs font-bold uppercase tracking-[0.2em] bg-brand-marinho text-white px-6 py-3 rounded-full hover:bg-brand-marinho/90 transition-all duration-300 w-fit shadow-lg shadow-brand-marinho/30"
            >
